...
namespace DataMatrixEugeni
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            viewForImage = FindViewById<ImageView>(Resource.Id.imageView1);
            convertAction = FindViewById<Button>(Resource.Id.convertButton);
            textView = FindViewById<TextView>(Resource.Id.errorMessage);
            convertAction.Click += ConvertAction;
            inputedText = FindViewById<EditText>(Resource.Id.inputText);
        }
